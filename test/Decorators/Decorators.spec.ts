...
describe('Decorators', function () {
    ...
    describe('Params', function () {
        ...
        it('Accepts 2 parameters', function (done) {
            chai.request(ExpressServer.server).post('/test/handler').send({
                one: 'hello',
                two: 'world'
            }).end((error, res) => {
    ...
    describe('Timeout', function () {
        ...
        it('Expires after timeout', function () {
            ...
            chai.request(ExpressServer.server).get('/test/timeout').end((error, res) => {
        ...
        it('Returns before timeout', function () {
            ...
            chai.request(ExpressServer.server).get('/test/timeout/pass').end((error, res) => {
                expect(res.body).to.not.haveOwnProperty('error');
